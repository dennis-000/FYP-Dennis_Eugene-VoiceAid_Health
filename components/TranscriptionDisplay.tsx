        ...
        <View style={[styles.transcriptionBox, { backgroundColor: colors.card, borderColor: colors.border }]}>
            {recording && (
                <View style={{ width: '100%', alignItems: 'center' }}>
                    <Text style={{ color: colors.primary, marginBottom: 10, fontWeight: 'bold' }}>{tr('listening')}</Text>
            ...
            {isProcessing && (
                <View style={{ alignItems: 'center', justifyContent: 'center' }}>
                    ...
                    <Text style={{ color: colors.subText, marginTop: 15 }}>{tr('analyzingAi')}</Text>
                </View>
            )}
                            ...
                            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}>
                                <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                                    ...
                                    <Text style={{ fontSize: 12, color: colors.subText, fontWeight: '600' }}>
                                        {isEditing ? tr('editTextLabel') : tr('whatYouSaidLabel')}
                                    </Text>
                                </View>
                                ...
                                {!isEditing && (
                                    ...
                                    >
                                        ...
                                        <Text style={{ color: '#FFF', fontSize: 12, fontWeight: '600' }}>{tr('edit')}</Text>
                                    </TouchableOpacity>
                                )}
                            </View>
                                    ...
                                    <View style={{ flexDirection: 'row', gap: 10, marginTop: 10 }}>
                                        ...
                                        {intentData?.refinedText && intentData.refinedText !== editedText && (
                                            ...
                                            >
                                                ...
                                                <Text style={{ color: colors.primary, fontWeight: '600' }}>{tr('useAiVersion')}</Text>
                                            </TouchableOpacity>
                                        )}
                                        ...
                                        >
                                            ...
                                            <Text style={{ color: '#FFF', fontWeight: '600' }}>{tr('confirm')}</Text>
                                        </TouchableOpacity>
                                        ...
                                        >
                                            <Text style={{ color: colors.text }}>{tr('cancel')}</Text>
                                        </TouchableOpacity>
                                    </View>
                                </>
                            ) : (
