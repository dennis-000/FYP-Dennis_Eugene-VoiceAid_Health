...
export const AppContext = createContext<{
  ...
  setTtsVoice: (val: 'male' | 'female') => void;
  reduceMotion: boolean;
  setReduceMotion: (val: boolean) => void;
  isScanningMode: boolean;
  setScanningMode: (val: boolean) => void;
}>({} as any);
...
export default function RootLayout() {
  ...
  const [isScanningMode, setScanningMode] = useState(false);
    ...
    <AuthProvider>
      <RoleProvider>
        <AppContext.Provider value={{ 
          ...
          largeText, setLargeText, ttsSpeed, setTtsSpeed, ttsVoice, setTtsVoice, reduceMotion, setReduceMotion,
          isScanningMode, setScanningMode
        }}>
