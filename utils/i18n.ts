...
const translations = {
    ...
    disconnectHospital: { en: 'Disconnect from Hospital', twi: 'Fi kuro hɔ', ga: 'Kɛ kuro' },
    exitGuestMode:  { en: 'Exit Guest Mode', twi: 'Fi apem mo hɔ',  ga: 'Fi nifo mo' },
    disconnectConfirmTitle: { en: 'Disconnect', twi: 'Fi mu', ga: 'Fi mu' },
    disconnectConfirmMessage: { en: 'Are you sure you want to disconnect from your hospital? You will need an invite code to reconnect.', twi: 'Wo gye di sɛ wopɛ sɛ wufi ayaresabea kuro yi mu? Wobɛhia koodu foforɔ na woatumi asan aka ho biom.', ga: 'Onyɛ ojwɛ akɛ obotue kɛjɛ bolga nifeemɔ nɛɛ mli? Obaahiɔ koodu he kɛha okpɛ.' },
    hospitalPatient: { en: 'Hospital Patient', twi: 'Ayaresafoɔ', ga: 'Bolga Helatsɛ' },
    guestPatient:    { en: 'Guest Patient',     twi: 'Apem',           ga: 'Guest Helatsɛ' },
    ...
    connectedHospital: { en: 'Connected to Hospital', twi: 'Kuro mu', ga: 'Bolga mu' },
    ...
    // HOSPITAL CONNECT
    // ────────────────────────────────────────
    connectTitle:   { en: 'Connect to Hospital', twi: 'Ka Ayaresabea Ho',  ga: 'Ka Bolga Ho' },
    ...
    hospitalBadge:      { en: '🏥 Hospital',       twi: '🏥 Ayaresabea',       ga: '🏥 Bolga' },
    guestBadge:         { en: '👤 Guest',          twi: '👤 Apem',            ga: '👤 Guest' },
    ...
    dischargedStatus:   { en: 'Discharged',        twi: 'Wapue',              ga: 'Eje bolga' },
    ...
    slpTemplatesTitle:  { en: 'SLP Templates',     twi: 'Ayaresa Nnwuma',      ga: 'Bolga Nifeemɔ' },
    ...
    useAsGuest:         { en: 'Use as Guest',      twi: 'Fa di dwuma sɛ Apem', ga: 'Okpɛ kɛha Guest' },
    useAsGuestDesc:     { en: 'Use the app independently without hospital affiliation', twi: 'Fa app yi di dwuma wo ho nko ara mma ayaresabea mmoa biara', ga: 'Okpɛ app nɛɛ okpɛ ba bolga' },
    connectToHospitalTitle: { en: 'Connect to Hospital', twi: 'Ka ho wɔ Ayaresabea', ga: 'Ka he ba Bolga mli' },
    hospitalAffiliationDesc: { en: "I'm affiliated with a healthcare organization", twi: 'Me ka ho wɔ ayaresabea bi mu', ga: 'Nifeemɔ oyɛ bolga mli' },
